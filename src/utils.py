...
class DebugOverlay:
    ...
    @classmethod
    def show(cls, frame: np.ndarray, state: str, ui_info: dict | None = None,
        ...
        cv2.putText(vis, f"State: {state}", (5, 22),
...
def _draw_box(img: np.ndarray, box: tuple | None, color: tuple, label: str):
    ...
    cv2.putText(img, label, (x, max(y - 4, 10)),
